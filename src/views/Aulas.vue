            ...
            <ul class="nav nav-tabs mb-4">
              <li class="nav-item">
                <a class="nav-link fw-bold" :class="{ active: tabActiva === 'dia' }" href="#" @click.prevent="tabActiva = 'dia'">
                  <i class="bi bi-building me-2"></i>Vista por Aulas
                </a>
              </li>
              <li class="nav-item">
                    ...
                    <div class="modal-body p-4">
                      <form @submit.prevent="saveClase">
                        <div class="row g-3">
                          ...
                          <div class="col-12 col-md-4">
                            <label class="form-label fw-bold">Espacio (Aula / Lab)</label>
...
const laboratorios = ref([
  { nombre: 'AU 106 Docencia III', color: '#1565C0', logo: '/logos/automatizacion.png', icon: 'bi bi-easel2-fill' },
  { nombre: 'AU 107 Docencia III', color: '#7B1FA2', logo: '/logos/ciencias.png', icon: 'bi bi-book-fill' },
  { nombre: 'AU 108 Docencia III', color: '#F57C00', logo: '/logos/electrica.png', icon: 'bi bi-pencil-fill' },
  { nombre: 'AU 109 Docencia III', color: '#00695C', logo: '/logos/electronica.png', icon: 'bi bi-projector-fill' },
  { nombre: 'AU 110 Docencia III', color: '#690035ff', logo: '/logos/reloj.png', icon: 'bi bi-journal-text' },
  { nombre: 'AU 111 Docencia III', color: '#576463ff', logo: '/logos/computadora.png', icon: 'bi bi-pc-display-horizontal' },
  { nombre: 'AU 406 Docencia IV', color: '#395a0fff', logo: '/logos/electronica.png', icon: 'bi bi-backpack-fill' },
  { nombre: 'AU 407 Docencia IV', color: '#395a0fff', logo: '/logos/electronica.png', icon: 'bi bi-laptop-fill' },
...
const todosLosEspacios = computed(() => {
  ...
  // Agregar laboratorios fijos por si la base está vacía
  const labsFijos = ['Lab de Automatización - Pesado I', 'Lab de Ciencias Básicas - Pesado I', 'Lab Eléctrica - Pesado I', 'Lab Electrónica - Pesado I', 'Lab Metrología - Pesado II', 'Cómputo III - Docencia II', 'Lab Manufactura - Pesado II'];
  labsFijos.forEach(l => espaciosUnicos.add(l));
...
const horasLibresPorDia = computed(() => {
  ...
  dias.slice(0, 5).forEach(dia => { // Lunes a Viernes
    ...
    clasesDia.forEach(clase => {
      ...
      // Si hay un hueco de al menos 30 min antes de la siguiente clase
